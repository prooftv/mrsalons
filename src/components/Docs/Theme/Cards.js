...
import posterCards from "@jsonFiles/guides.json"
import propertyCards from "@jsonFiles/index4.json"
import postCards from "@jsonFiles/blog.json"
import reviewCards from "@jsonFiles/detail-rooms.json"
import teamCards from "@jsonFiles/team.json"
import testimonialCards from "@jsonFiles/index.json"
  ...
  return (
    <div id="cards" className="docs-item element">
      ...
      <div className="docs-desc">
        <p className="lead">
          This theme comes with a variety of card styles useful for directory
      ...
      <div className="mt-5">
        ...
        <Row>
          <Col md="6">
            <CardTestimonial
              data={testimonialCards.testimonials.swiperItems[0]}
            />
          </Col>
          <Col md="6" className="d-none d-md-block">
            <CardTestimonial
              data={testimonialCards.testimonials.swiperItems[1]}
            />
          </Col>
        </Row>
        <div className="my-5">
