  ...
  return (
    <div id="gallerywithlightbox" className="docs-item element">
      ...
      <div className="docs-desc">
        ...
        <p>
          React Image Lightbox is a responsive lightbox &amp; dialog script with
          focus on performance and providing best experience for user with any
          device.
        </p>
        <p>
        ...
        <ul>
          <li>
            <b>rowClasses</b> - classes for <code>Row</code> element
          </li>
          <li>
            <b>colClasses</b> - classes for <code>Col</code> element
          </li>
          <li>
            <b>data</b> - images object
          </li>
          <li>
            <b>xs</b> - extra small column size
          </li>
          <li>
            <b>sm</b> - small column size
          </li>
          <li>
            <b>md</b> - medium column size
          </li>
          <li>
            <b>lg</b> - large column size
          </li>
          <li>
            <b>xl</b> - extra large column size
          </li>
        </ul>
      </div>
