  ...
  return (
    <div id="ribbon" className="docs-item element">
      ...
      <div className="docs-desc">
        <p className="lead">
          Ribbons can be used in the venue component, venue carousels but also
          separately. Its parent needs a <code>position: relative;</code> and
          you can use theme colours for ribbon backgrounds.
        </p>
      </div>
      <div className="mt-5">
